...
2. Inyectar Http en el servicio de movies con constructor(private  http:  HttpClient) {}

3. Crear un método para realizar una petición GET, usando HTTP. Ejemplo:
...
4. En el componente, inyectar el servicio, realizar la suscripción para ejecutar la llamada y obtener los títulos de los episodios. Los títulos de los episodios, se pueden mostrar en un componente ya creado, o en un nuevo componente para series con su propio ruteo series (opcional a elección).
